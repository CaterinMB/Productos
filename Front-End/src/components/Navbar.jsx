...
const Navbar = () => {
  ...
  return (
    <div className="bg-white flex">
      <div className="menu bg-[#201e1e] min-h-screen flex flex-col justify-start items-start p-3">
        ...
        <ul className="mt-8 space-y-6">
          ...
          <li>
            <div
              className="flex items-center text-white p-2 rounded ml-5 cursor-pointer"
            >
